...
public class Vector3 implements Comparable<Vector3> {
    ...
    /**
     * Constructs a new Renderer.Vector3 with the given x, y, z
     *
     * @param x
     * @param y
     * @param z
    ...
    /**
     * Constructs a new Renderer.Vector3 with all elements set to 0
     */
    public Vector3() {
        this(0, 0, 0);
    }
    ...
    /**
     * Constructs a new Renderer.Vector3 that is a clone of the given vector3
     *
     * @param clone
     */
    ...
    /**
     * Constructs a new Renderer.Vector3 from the given Renderer.Vector2 and z
     *
     * @param vector
     * @param z
     */
    ...
    /**
     * Constructs a new Renderer.Vector3 from the given Renderer.Vector2 and z set to 0
     *
     * @param vector
     */
    ...
    /**
     * Returns a Renderer.Vector2 object using the X and Z values of
     * this Renderer.Vector3. The x of this Renderer.Vector3 becomes the x
     * of the Renderer.Vector2, and the z of this Renderer.Vector3 becomes the
     * y of the Renderer.Vector2.
     *
     * @return
     */
    ...
    /**
     * Rounds the X, Y, and Z values of this Renderer.Vector3 up to
    ...
    /**
     * Rounds the X, Y, and Z values of this Renderer.Vector3 down to
     * the nearest integer value.
     *
     * @return
     */
    ...
    /**
     * Rounds the X, Y, and Z values of this Renderer.Vector3 to
     * the nearest integer value.
     *
     * @return
     */
    ...
    /**
     * Sets the X, Y, and Z values of this Renderer.Vector3 to their
     * absolute value.
     *
     * @return
     */
    ...
    /**
     * Gets the distance between this Renderer.Vector3 and a given Renderer.Vector3.
     *
     * @param a
     * @return
     */
    ...
    /**
     * Raises the X, Y, and Z values of this Renderer.Vector3 to the given power.
     *
     * @param power
     * @return
     */
    ...
    /**
     * Rounds the X, Y, and Z values of the given Renderer.Vector3 up to
     * the nearest integer value.
     *
     * @param o Renderer.Vector3 to use
     * @return
     */
    ...
    /**
     * Rounds the X, Y, and Z values of the given Renderer.Vector3 down to
     * the nearest integer value.
     *
     * @param o Renderer.Vector3 to use
     * @return
    ...
    /**
     * Rounds the X, Y, and Z values of the given Renderer.Vector3 to
     * the nearest integer value.
     *
     * @param o Renderer.Vector3 to use
     * @return
    ...
    /**
     * Sets the X, Y, and Z values of the given Renderer.Vector3 to their
     * absolute value.
     *
     * @param o Renderer.Vector3 to use
     * @return
    ...
    /**
     * Returns a Renderer.Vector3 containing the smallest X, Y, and Z values.
     *
     * @param o1
     * @param o2
     * @return
    ...
    /**
     * Returns a Renderer.Vector3 containing the largest X, Y, and Z values.
     *
     * @param o1
     * @param o2
     * @return
    ...
    /**
     * Returns a Renderer.Vector3 with random X, Y, and Z values (between 0 and 1)
     *
     * @return
     */
    ...
    /**
     * Gets the distance between two Renderer.Vector3.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Raises the X, Y, and Z values of a Renderer.Vector3 to the given power.
     *
     * @param o
     * @param power
     * @return
    ...
    /**
     * Returns a Renderer.Vector2 object using the X and Z values of
     * the given Renderer.Vector3. The x of the Renderer.Vector3 becomes the x
     * of the Renderer.Vector2, and the z of this Renderer.Vector3 becomes the
     * y of the Vector2m.
     *
     * @param o Renderer.Vector3 object to use
     * @return
     */
     ...
     * Returns a Vector2m object using the X and Z values of
     * the given Renderer.Vector3. The x of the Renderer.Vector3 becomes the x
     * of the Vector2m, and the z of this Renderer.Vector3 becomes the
     * y of the Vector2m.
     *
     * @param o Renderer.Vector3 object to use
     * @return
